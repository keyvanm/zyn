...
| **gigazyn** | nvim pack: [`giga.nvim`](https://github.com/keyvanm/giga.nvim) + [`zyn.nvim`](https://github.com/keyvanm/zyn.nvim). Replaces a standalone zyn.nvim install.                                                                                                                                                                                                                  | neovim, tree-sitter |
...
> [!NOTE]
> `gigazyn` includes giga.nvim's language pack, which expects external formatters and LSPs (ruff, ty, marksman, stylua, …). See giga.nvim's [Requirements](https://github.com/keyvanm/giga.nvim#requirements).
